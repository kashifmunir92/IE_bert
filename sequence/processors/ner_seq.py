...
class CluenerProcessor(DataProcessor):
    ...
    def get_new_test_examples(self, data_dir, file_path):
        """See base class."""
        # logger.info('当前预测文件:',data_dir,file_path)
        # print(123123,self._create_examples(self._read_json(os.path.join(data_dir, file_path)), "test"))
        return self._create_examples(self._read_json(os.path.join(data_dir, file_path)), "test")

    def get_labels(self):
        """See base class."""
        labels = ["X", 'O', "[START]", "[END]"]
...
ner_processors = {
    ...
    'patent_ocr': CluenerProcessor,
    'anchor_text': CluenerProcessor,
    'patent_names': CluenerProcessor
}
