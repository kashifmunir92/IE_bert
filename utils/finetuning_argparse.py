...
def get_argparse():
    ...
    parser.add_argument("--task_name", default='ner_test', type=str, required=True,
    ...
    #custom add
    parser.add_argument("--predict_data_dir", type=str, default="", help=".")
    parser.add_argument("--predict_result_dir", type=str, default="", help=".")
    parser.add_argument("--predict_task_start_end", type=str, default="", help=".")
    parser.add_argument("--use_device", type=str, default="1", help=".")
